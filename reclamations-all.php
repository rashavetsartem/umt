...
<div class= "tabcontent">
  <div class="row" style="width: 40%; height:70px; margin-bottom: 10px; margin-left: 10px;">
      <div class="col-sm" style="border: 2px solid grey; margin: 5px 5px  -webkit-border-radius: 6px; -moz-border-radius: 6px; border-radius: 6px;">
        <p style="top:20%; left:10px; font-size: 14px; font-weight: bold;">Отслеженно рекламаций на сумму:

        <?php
          $reclamations_sum = get_reclamations_sum();
            printf('%s %s %s','<span style="color:blue; font-size: 16px; padding-left:10px;">',$reclamations_sum['reclamation_total'],'грн.</span>'); 
        ?>
  ...
  <table class="table table-bordered table-sm table-hover">
    <thead class="thead">
      ...
      <?php $reclamations = get_reclamation();
